...
import type { Gruenderprofil, Phasen, Meilensteine, Aufgaben, VorlagenTools, ReviewPunkte, RoadmapCockpit, CreateGruenderprofil, CreatePhasen, CreateMeilensteine, CreateAufgaben, CreateVorlagenTools, CreateReviewPunkte, CreateRoadmapCockpit } from '@/types/app';
