...
import type { VorlagenTools, Businessplan, Finanzplan, Meilensteine, Aufgaben, Gruenderprofil, Phasen, ReviewPunkte, RoadmapCockpit, CreateVorlagenTools, CreateBusinessplan, CreateFinanzplan, CreateMeilensteine, CreateAufgaben, CreateGruenderprofil, CreatePhasen, CreateReviewPunkte, CreateRoadmapCockpit } from '@/types/app';
