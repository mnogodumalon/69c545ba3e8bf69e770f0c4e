...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings, IconSquareCheck } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import ActionsBar from '@/components/ActionsBar';

const APP_TITLE = 'Existenzgründungs-Roadmap';
...
const navigation = [
  ...
  { name: 'Vorlagen & Tools', href: '/vorlagen-&-tools', icon: IconFileText },
  { name: 'Meilensteine', href: '/meilensteine', icon: IconFileText },
  { name: 'Phasen', href: '/phasen', icon: IconFileText },
  { name: 'Gründerprofil', href: '/gruenderprofil', icon: IconFileText },
  { name: 'Roadmap-Cockpit', href: '/roadmap-cockpit', icon: IconFileText },
  { name: 'Review-Punkte', href: '/review-punkte', icon: IconFileText },
  { name: 'Businessplan', href: '/businessplan', icon: IconFileText },
  { name: 'Finanzplan', href: '/finanzplan', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Aufgaben', href: '/gateway/apps/69c5457338dee1223162d8ea?template=list_page', icon: IconSquareCheck },
  { name: 'Vorlagen & Tools', href: '/gateway/apps/69c54574802124266829d88d?template=list_page', icon: IconFileText },
  { name: 'Meilensteine', href: '/gateway/apps/69c5457263560a48066e92c4?template=list_page', icon: IconFileText },
  { name: 'Phasen', href: '/gateway/apps/69c54571f147e4e484ea484e?template=list_page', icon: IconFileText },
  { name: 'Gründerprofil', href: '/gateway/apps/69c54567f38f0d936edaa827?template=list_page', icon: IconFileText },
  { name: 'Roadmap-Cockpit', href: '/gateway/apps/69c54576c2a189f872b56772?template=list_page', icon: IconFileText },
  { name: 'Review-Punkte', href: '/gateway/apps/69c54575290ee4a096f988e2?template=list_page', icon: IconFileText },
  { name: 'Businessplan', href: '/gateway/apps/69c54d3ec37912750dddb336?template=list_page', icon: IconFileText },
  { name: 'Finanzplan', href: '/gateway/apps/69c54d3fcf729c62a2ff3893?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c5457338dee1223162d8ea?template=list_page"
