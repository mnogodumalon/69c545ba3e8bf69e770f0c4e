import type { EnrichedAufgaben, EnrichedMeilensteine, EnrichedReviewPunkte, EnrichedRoadmapCockpit, EnrichedVorlagenTools } from '@/types/enriched';
import type { Aufgaben, Gruenderprofil, Meilensteine, Phasen, ReviewPunkte, RoadmapCockpit, VorlagenTools } from '@/types/app';
