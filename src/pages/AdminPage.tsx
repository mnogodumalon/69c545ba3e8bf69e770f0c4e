...
const VORLAGENTOOLS_FIELDS = [
  ...
  { key: 'tool_typ', label: 'Typ', type: 'lookup/select', options: [{ key: 'excel', label: 'Excel-Vorlage' }, { key: 'checkliste', label: 'Checkliste' }, { key: 'strukturvorlage', label: 'Strukturvorlage / Gliederung' }, { key: 'fragenkatalog', label: 'Fragenkatalog' }, { key: 'praesentation', label: 'Präsentationsvorlage' }, { key: 'online_tool', label: 'Online-Tool / Software' }, { key: 'sonstiges', label: 'Sonstiges' }] },
